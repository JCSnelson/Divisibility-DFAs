...
\begin{proof}
  ...
  Case 1: $q_m$ is in the $2^\alpha$ part of the dfa $0\leq m \leq \alpha-1$ then the string is just $s_w=0^m$ and we know the run of this ends at $q_m$ by definition.\\
